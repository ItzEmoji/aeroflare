...
import (
	...
	"github.com/itzemoji/aeroflare/v2/pkg/cmd/auth"
	"github.com/itzemoji/aeroflare/v2/pkg/cmd/blob"
	"github.com/itzemoji/aeroflare/v2/pkg/cmd/configure"
	initcmd "github.com/itzemoji/aeroflare/v2/pkg/cmd/init"
	"github.com/itzemoji/aeroflare/v2/pkg/cmd/prepare"
	"github.com/itzemoji/aeroflare/v2/pkg/cmd/proxy"
	"github.com/itzemoji/aeroflare/v2/pkg/cmd/push"
	"github.com/itzemoji/aeroflare/v2/pkg/cmd/run"
	"github.com/itzemoji/aeroflare/v2/pkg/cmd/settings"
	"github.com/itzemoji/aeroflare/v2/pkg/cmd/version"
